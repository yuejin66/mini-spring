...
//        }
    ...
    protected void doLoadBeanDefinitions(InputStreamReader inputStreamReader) throws ClassNotFoundException {
        Document document = XmlUtil.readXML(inputStreamReader);
